...
fn lookup(lang: &str, key: &str) -> &'static str {
    match (lang, key) {
        ...
        ("en", "tools/tool_search") => include_str!("../../prompts/en/tools/tool_search_description.md.j2"),
        ("en", "tools/tool_execute") => include_str!("../../prompts/en/tools/tool_execute_description.md.j2"),
